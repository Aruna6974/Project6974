  ...
  //  using Arraylist to store even numbers from 2 to N,where N is a Integer
   ...
   //else return zero.
   /*Hint: Use instance variable for storing theArrayList A1 and A2.
    * 
    */
...
public class ListArrayList 
{
	...
	{
		ListArrayList lst=new ListArrayList();
		lst.saveEvenNumbers(10);
